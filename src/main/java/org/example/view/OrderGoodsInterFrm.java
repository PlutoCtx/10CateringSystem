...
public class OrderGoodsInterFrm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jb_add.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(Objects.requireNonNull(getClass().getResource("/cart.png"))))); // NOI18N
        jb_add.setText("加入购物车");
        jb_add.addActionListener(this::jb_addActionPerformed);

        jb_ok.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/ok.png")))); // NOI18N
        jb_ok.setText("结算");
        jb_ok.addActionListener(this::jb_okActionPerformed);

        jb_delete.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/delete.png")))); // NOI18N
        jb_delete.setText("删除");
        jb_delete.addActionListener(this::jb_deleteActionPerformed);
                                                ...
                                                .addGroup(
                                                        layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(layout
                                                                        ...
                                                                        .addGroup(
                                                                                javax.swing.GroupLayout.Alignment.TRAILING,
                                                                                layout.createSequentialGroup().addComponent(jb_delete)
                                                                        ...
                                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                                                ...
                                                                                .addGroup(
                                                                                        layout.createSequentialGroup().addComponent(
                                                                                                jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(18, 18, 18)))
                                                                        .addComponent(jb_add))
